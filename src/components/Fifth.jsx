...
function Fifth() {
  return (
    <div className="bg-white w-full h-screen pt-28 lg:rounded-t-[150px] md:rounded-t-[100px] sm:rounded-t-[50px] flex flex-col lg:flex-row">
      <div className="lg:w-1/2 p-16">
        <button className="font-bold rounded-full sm:py-4 px-7 border-solid border-2 border-black">
          LET'S BEGIN
        </button>
        <h1 className="text-[64px] font-bold">
          How To Start Learning With upskillink
        </h1>
      ...
      <div className="relative sm:p-6 p-4 pt-26 w-full lg:w-1/2">
        ...
        <div className="flex flex-col sm:flex-row items-center sm:space-x-4">
          ...
          <div className="h-18">
            ...
            <p className="text-[#959595] pt-4">
              Design a clear, goal-oriented curriculum that aligns with your
              expertise and meets learners' needs. Create structured lessons or
              flexible sessions to guide students effectively.
            </p>
          </div>
        </div>
        ...
        <div className="flex flex-col sm:flex-row items-center sm:space-x-4 mt-10">
          ...
          <div className="h-18">
            ...
            <p className="text-[#959595] pt-4">
              Conduct live sessions that inspire and educate. Use our platform
              to provide interactive and impactful learning experiences through
              personalized and group classes.
            </p>
          </div>
        </div>
        ...
        <div className="flex flex-col sm:flex-row items-center sm:space-x-4 mt-10">
          ...
          <div className="h-18">
            ...
            <p className="text-[#959595] pt-4">
              Create and manage a dynamic learning hub. Foster collaboration,
              host discussions, and build a supportive network that enhances the
              learning journey for all members.
            </p>
          </div>
        </div>
      </div>
